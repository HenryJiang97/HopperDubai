<template>
	<view class="page" @touchstart="touchStart" @touchend="touchEnd">	
		...
		<view class="cu-bar bg-white solid-bottom " >
				...
				<view class="action">
					<button class="margin padding-lr" type="primary" @tap="send">
						<text>发表</text>
					</button>
				</view>
		</view>
		...
		<form>
			<view class="cu-form-group margin-top-sm">
				<textarea maxlength="-1"  @input="textareaAInput" placeholder="这一刻的想法..."></textarea>
			</view>
...
export default {
	...
	data() {
		return {
			...
			limitNumber: 8,
			imageData : [],
			serverUrl: 'http://localhost:1337/upload/',
	...
	methods: {
		...
		async send(){
			let r = await Parse.Cloud.run('postPolish')
		},
		ChooseImage() {
				uni.chooseImage({
					count: 4, //默认9
